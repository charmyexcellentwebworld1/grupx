         ...
         <div class="col col-xxl-7 col-md-7 col-sm-12 col-xs-12 p-0">
            <div class="cnt-wrapper">
               ...
               <div class="btn-group w-100 d-flex align-items-center gap-3">
                  <button type="button" class="btn dir-btn" data-bs-toggle="modal" data-bs-target="#applicationSubmit">Send Friend Request <span><img src="assets/images/curve-arrow.svg"
                     alt="" /></span></button>
               </div>
            </div>
         </div>
